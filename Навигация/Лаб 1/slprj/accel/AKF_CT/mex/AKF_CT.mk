...
MODEL                = AKF_CT
MODULES              = AKF_CT_acc.c AKF_CT_acc_data.c c_mexapi_version.c lccstub.c
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/AKF_CT \
...
AKF_CT_acc.obj : $(START_DIR)/slprj/accel/AKF_CT/AKF_CT_acc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AKF_CT/AKF_CT_acc.c

AKF_CT_acc_data.obj : $(START_DIR)/slprj/accel/AKF_CT/AKF_CT_acc_data.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AKF_CT/AKF_CT_acc_data.c
