...
MODEL                = AKF_CT1
MODULES              = AKF_CT1_acc.c AKF_CT1_acc_data.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/AKF_CT1_acc.mexw64
MAKEFILE             = AKF_CT1.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2022a
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2022a
START_DIR            = C:/Projects/Study/33AD~1/12AF1~1
S_FUNCTIONS_LIB      = 
NUMST                = 7
NCSTATES             = 0
...
MODELLIB                  = AKF_CT1_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = AKF_CT1_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/AKF_CT1 \
...
AKF_CT1_acc.obj : $(START_DIR)/slprj/accel/AKF_CT1/AKF_CT1_acc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AKF_CT1/AKF_CT1_acc.c

AKF_CT1_acc_data.obj : $(START_DIR)/slprj/accel/AKF_CT1/AKF_CT1_acc_data.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AKF_CT1/AKF_CT1_acc_data.c
