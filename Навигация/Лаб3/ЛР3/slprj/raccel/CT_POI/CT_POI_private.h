#ifndef RTW_HEADER_CT_POI_private_h_
#define RTW_HEADER_CT_POI_private_h_
#include "rtwtypes.h"
...
minorStepAndTAtLastMajorOutput ) ; real_T rt_VTDelayfindtDInterpolate (
real_T x , real_T * uBuf , int_T bufSz , int_T head , int_T tail , int_T *
...
; void rt_TDelayFreeBuf ( void * buf ) ;
